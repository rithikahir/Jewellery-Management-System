...
//$bid=$_GET["field1"];
$querry=mysqli_query($conn,"SELECT BAmount,BQuantity,Tax,PDate ,TAmount FROM bill where BID='".$_GET['field1']."'");
	...
	<div class="imglog">
		...
		<div class="stock"><center class="formtitle"><span>B</span>ill Details<center><br>
			...
			<table>
				...
				<tr>
    				<td>Customer ID : </td>
  				 <td><input type="numeric" name="cid" id="cid" value="<?= $_GET["field2"]?>" readonly="readonly" /></td>
  				</tr>
				<tr>
    				<td>Employee ID : </td>
  				 <td><input type="numeric" name="eid" id="eid" value="<?= $eid ?>" readonly="readonly" /></td>
  				</tr>
				<tr>
    				<td>Date : </td>
				...
				<tr>
  				...
  				<tr>
  				 ...
  				 <td><input type="numeric" name="amount" id="amount" value="<?= $amount ?>" readonly="readonly"/></td>
  				</tr>
				<tr>
    				<td>GST ( % ) : </td>
  				...
  				<tr>
				<td>Total Amount : </td>
  				<td> <input type="numeric" name="tamount" id="tamount" value="<?=$tamt?>" readonly="readonly" /></td>
  				 </tr>
  				</table>
  				<input type="submit" id="savbill" name="savbill" value="Save Bill" class="btn"> 
			</form>
		</div>
	</div>
	</div>
